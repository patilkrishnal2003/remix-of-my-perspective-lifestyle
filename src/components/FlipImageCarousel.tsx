  ...
  return (
    <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
      ...
      <div className="relative lg:col-span-3">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-accent/10 to-transparent rounded-[4rem]" />
        <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-accent/20 rounded-full blur-2xl" />
        
        <div className="relative p-4 sm:p-6">
          <div className="relative aspect-[16/9] rounded-[4rem] overflow-hidden" style={{ perspective: "1000px" }}>
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              />
              {/* Overlay gradient */}
              <div className="absolute inset-0 bg-gradient-to-t from-foreground/40 via-transparent to-transparent rounded-[4rem]" />
            </motion.div>
          </AnimatePresence>
          </div>
        </div>
