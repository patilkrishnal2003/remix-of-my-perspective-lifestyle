...
const Footer = () => {
  return (
    <footer className="relative mt-12 sm:mt-16 bg-gradient-to-br from-primary/10 via-primary/5 to-background overflow-hidden z-10 rounded-b-[3rem] sm:rounded-b-[4rem] lg:rounded-b-[5rem]">
