...
const Footer = () => {
  return (
    <footer className="relative mt-12 sm:mt-16 bg-foreground">
      ...
      <div className="relative z-10 bg-background rounded-b-[3.5rem] sm:rounded-b-[4.5rem]" style={{ marginTop: "-200px" }}>
        {/* Gradient overlay to match hero */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary/15 via-primary/10 to-primary/15 rounded-b-[3.5rem] sm:rounded-b-[4.5rem]" />
        {/* Background grid pattern to match hero */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,hsl(var(--foreground)/0.06)_1px,transparent_1px),linear-gradient(to_bottom,hsl(var(--foreground)/0.06)_1px,transparent_1px)] bg-[size:4rem_4rem] rounded-b-[3.5rem] sm:rounded-b-[4.5rem]" />
