...
const Footer = () => {
  return (
    <div className="mt-12 sm:mt-16">
      ...
      <div className="relative bg-background rounded-b-[3rem] sm:rounded-b-[4rem] z-10">
      ...
      {/* Black logo section - visible below the curved footer */}
      <div className="bg-foreground h-[200px] flex items-center justify-center px-4 sm:px-6 lg:px-8">
