...
export default function TestimonialCard({ t, highlight = false }: { t: Testimonial; highlight?: boolean }) {
  return (
    <div
      className={cn(
        "group relative flex flex-col justify-between rounded-[4rem] border bg-card p-6 transition-all duration-300 cursor-pointer hover:scale-[1.03] hover:shadow-xl",
