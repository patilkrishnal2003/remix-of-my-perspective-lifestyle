...
const HeroImageCarousel = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-50 translate-y-[45%] sm:translate-y-[55%] md:translate-y-[58%] flex justify-center px-4 sm:px-6 lg:px-8 mb-6 sm:mb-8 md:mb-10">
      ...
      >
        <div className="relative rounded-[1.25rem] sm:rounded-[1.5rem] overflow-hidden border-2 border-border bg-background p-3 sm:p-4 shadow-2xl shadow-primary/10">
          <div className="rounded-xl sm:rounded-[1.25rem] overflow-hidden relative aspect-[16/9]">
