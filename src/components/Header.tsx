    ...
    return (
      <header className="fixed top-0 left-0 right-0 z-50 pt-3 sm:pt-4 animate-slide-down">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-2 py-4 px-4 rounded-2xl bg-background/95 backdrop-blur-xl border border-border animate-fade-in max-h-[calc(100vh-6rem)] overflow-y-auto">
