...
export default function ResourcesTabSection() {
  ...
  return (
    <section className="section-divider max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pt-24">
      ...
      <div className="rounded-[2.5rem] sm:rounded-[3rem] bg-gradient-to-br from-emerald-200/90 via-teal-100/80 to-green-200/85 dark:from-emerald-800/30 dark:via-teal-800/25 dark:to-green-800/30 p-6 sm:p-10 md:p-14 lg:p-16">
        {/* Header */}
