...
export default function ResourcesTabSection() {
  ...
  return (
    <section className="section-divider max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pt-24">
      ...
      <div className="rounded-[2.5rem] sm:rounded-[3rem] bg-gradient-to-br from-sky-200/90 via-blue-100/80 to-indigo-200/85 dark:from-sky-800/30 dark:via-blue-800/25 dark:to-indigo-800/30 p-6 sm:p-10 md:p-14 lg:p-16">
        {/* Header */}
