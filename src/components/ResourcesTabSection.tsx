...
function ResourceCard({ image, title, category, description, excerpt, results, readTime, isLink, to }: CardProps) {
  const content = (
    <div className="group relative rounded-[1.5rem] overflow-hidden bg-card border border-border transition-all duration-500 hover:border-primary/40 hover:shadow-2xl hover:-translate-y-2 h-full flex flex-col">
