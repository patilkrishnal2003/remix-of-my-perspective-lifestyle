...
export default function CTASection({
  ...
  return (
    <section className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${compact ? "py-8" : "py-10 sm:py-12"}`}>
      <div
        className="relative rounded-3xl bg-gradient-to-r from-primary via-primary/90 to-primary hover:from-primary/95 hover:via-primary/85 hover:to-primary/95 text-primary-foreground p-6 sm:p-8 md:p-10 text-center overflow-hidden transition-all duration-500 hover:shadow-xl group"
      >
