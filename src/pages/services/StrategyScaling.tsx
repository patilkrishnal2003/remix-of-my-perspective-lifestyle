...
const StrategyScaling = () => {
  ...
  const technologies = ["Google Analytics 4", "Mixpanel", "Amplitude", "Tableau", "Looker", "Segment"];

  const benefits = [
    "Market analysis & competitive research",
    "Product-market fit validation",
    "Monetization strategy development",
    "KPI frameworks & goal setting",
    "GA4/Mixpanel dashboard setup",
    ...
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main>
              ...
              <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1] text-foreground">
                    Analytics &
                    <span className="block text-primary">Scaling</span>
                  </h1>
        ...
        <CTASection 
          ...
          description="Let's build your growth strategy together."
