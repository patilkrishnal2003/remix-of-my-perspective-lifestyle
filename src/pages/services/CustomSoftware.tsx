...
const CustomSoftware = () => {
  const features = [
    ...
    { icon: Link2, title: "System Integration", description: "Connect all your tools and platforms seamlessly." },
    { icon: BarChart3, title: "Business Intelligence", description: "Data-driven insights for better decisions." },
  ];

  const technologies = ["Python", "Java", "C#", ".NET", "Node.js", "PostgreSQL", "MongoDB"];
    ...
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main>
        ...
        <CTASection 
          ...
          description="Let's build custom software that drives your success."
