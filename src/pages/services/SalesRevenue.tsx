...
const SalesRevenue = () => {
  ...
  const technologies = ["HubSpot", "Salesforce", "Pipedrive", "Lemlist", "Apollo", "Zapier"];

  const benefits = [
    "Lead funnel design for B2B & B2C",
    "CRM selection & automation setup",
    "Email & WhatsApp sequences",
    "Sales pipeline optimization",
    "Marketing → Sales handover automation",
    ...
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main>
        ...
        <CTASection 
          ...
          description="Let's build your revenue engine together."
