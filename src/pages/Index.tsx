    ...
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="rounded-[2.5rem] bg-foreground text-background p-12 md:p-16 text-center animate-scale-in">
            <div className="max-w-3xl mx-auto space-y-6">
              ...
              <Link to="/contact">
                <Button className="bg-background text-foreground hover:bg-background/90 rounded-full px-10 py-6 text-lg hover:scale-105 transition-all mt-4">
